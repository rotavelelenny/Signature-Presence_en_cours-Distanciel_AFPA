...
<head>
  ...
  <title>Selection - Manager / Administration - Choix du document</title>
    ...
    <div class="container_docs">
        ...
        <div class="document_btn">
            <button class="document">
              <a href="Administration_Manager_Prestation_accompagnement_recap.php">Document 1
        ...
        <div class="document_btn">
            <button class="document">
            <a href="Administration_Manager_Presence_recap.php">Document 2
        ...
        <div class="document_btn">
            <button class="document">
            <a href="Administration_Manager_Suivi_realisation_recap.php">Document 3
