...
<head>
    ...
    <title>Manager - Formation, Stagiaire(Nom) et semaine - étape 2</title>
...
<?php include ("menu_afpa_presentiel.php");?>
  ...
  <main class="container_selecteur">
    ...
    <div class="bloc_fils droite">
      ...
      <form method="post" action="All_signature.php">
        <select class="selecteur" name="day" id="day">
          <option value="0">Sélectionnez --</option>
          <option class="change_select" value="1">Matin</option>
          <option class="change_select" value="2">Après-midi</option>
          <option class="change_select" value="6">Journée entière</option>
        </select>
        <!-- <input type="submit" value="Valider">  -->
      </form>
    </div>
